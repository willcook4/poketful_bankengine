...
const YSPImg = ({ name }) => {
  return <YSP src={ysp} alt={name} />;
};

const YSPFirstName = "Harry";
const YSPLastName = "Te Mana";
          ...
          <React.Fragment>
            <React.Fragment>
              ...
              >
                ...
                >
                  {context.msgHistory &&
                  context.msgHistory.msgHistory.length > 0 ? (
                    <List
                      ...
                      renderItem={item => (
                        <li
                          style={{
                            ...
                            paddingRight: "14px",
                            backgroundColor:
                              item.from === "user" ? "lightyellow" : "white"
                          }}
                        >
                          <Comment
                            actions={[]}
                            author={
                              item.from === "user" ? "Danielle" : YSPFirstName
                            } // hardcoded?!!!
